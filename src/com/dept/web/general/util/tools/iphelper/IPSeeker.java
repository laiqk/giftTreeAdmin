package com.dept.web.general.util.tools.iphelper;
...
public class IPSeeker {
    ...
    private void init(){
         ...
         b4 = new byte[4];
         b3 = new byte[3];
         IP_FILE = IPSeeker.class.getResource("qqwry.dat").toString().substring(5);
         try {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(aa.getAddress("0.0.0.1"));
    }
    
/**
 * 
 * @ClassName:     IPSeeker.java
 * @Description:   TODO
 *
 * @author         cannavaro
 * @version        V1.0 
 * @Date           2014-10-16 下午1:45:21
