...
public class MoneyToChinese {
    ...
    public static void main(String[] args) {  
        ...
        System.out.println(format2Str(2000.11));  
    }  
    ...
    public static String showMoneyChineseString(double money){

        double moneyT = money/10000;
     ...
     * @throws
     */
    public static double format3Str(double a,double b){
        DecimalFormat df = new DecimalFormat("0.00"); 
        Double d1=Double.parseDouble(df.format(a));
        Double d2=Double.parseDouble(df.format(b));
        return d1+d2;
    }
